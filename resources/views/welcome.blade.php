...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'Papermore Project Management') }}</title>
        ...
        <div class="min-h-screen flex flex-col items-center">
            <header class="w-full py-6 px-6 sm:px-10 flex justify-between items-center">
                <div class="flex items-center space-x-2">
                    ...
                    <span class="text-xl font-semibold">Papermore</span>
                </div>
            ...
            <footer class="w-full py-8 px-6 sm:px-10">
                <div class="max-w-4xl mx-auto text-center">
                    <p class="text-gray-600">© {{ date('Y') }} Papermore. All rights reserved.</p>
